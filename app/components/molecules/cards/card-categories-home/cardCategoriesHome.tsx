...
const Card: React.FC<CardCategoriesHomeProps> = ({ category }) => {
    return (
      <section className="max-w-sm rounded overflow-hidden shadow-lg">
        ...
        <section className="px-6 pt-4 pb-2">
          <Link href={category.link} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              Voir la collection
          </Link>
        </section>
      </section>
